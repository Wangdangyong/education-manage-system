<template>
  ...
  <div>
    ...
    >
      <el-table-column prop="depNo" label="院系编号" width="160">
      </el-table-column>
      <el-table-column prop="depName" label="院系名" width="300">
      </el-table-column>
      <el-table-column prop="depMajorCount" label="专业数量" width="180">
      </el-table-column>
      <el-table-column prop="depTeaCount" label="教师人数" width="180">
      </el-table-column>
